...
Feature: Servicio de Usuarios
    ...
    Scenario: Probar que no soy capaz de borrar un usuario que no existe
        Given un servicio backend de mentirijillla
          And el servicio no tiene el usuario con id 2
         When se invoca la función "deleteUser", con el valor 2 y una función de callback que captura su respuesta
         Then la respuesta debe contener 2 argumentos
          And el argumento 1 no debe llegar vacio
          And el argumento 2 debe llegar vacio
    ...
    Scenario Template: Probar que soy capaz de crear un usuario que existe desde su id
        Given un servicio backend de mentirijillla
         When creo un objeto json,
          And con "nombre": "<nombre>"
          And con "apellidos": "<apellidos>"
          And con "edad": <edad>
          And con "email": "<email>"
          And se invoca la función "createUser", con ese objeto json y una función de callback que captura su respuesta
         Then la respuesta debe contener 2 argumentos
          And el argumento 1 debe llegar vacio
          And el argumento 2 debe tener un "objeto json"
          And el argumento 2 tiene por "id" de tipo "numerico"
          And el argumento 2 tiene por "nombre": "<nombre>"
          And el argumento 2 tiene por "apellidos": "<apellidos>"
          And el argumento 2 tiene por "edad": <edad>
          And el argumento 2 tiene por "email": "<email>"
         When se invoca la función "getUser", con el "id" del argumento 2 de la respuesta anterior y una función de callback que captura su respuesta
         Then la respuesta debe contener 2 argumentos
          And el argumento 1 debe llegar vacio
          And el argumento 2 debe tener un "objeto json"
          And el argumento 2 tiene por "nombre": "<nombre>"
